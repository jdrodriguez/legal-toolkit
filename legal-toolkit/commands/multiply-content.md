...
# /multiply-content -- Content Multiplier
...
- **Detect input type** -- if audio/video, chain to `/legal-toolkit:transcribe` first; if PDF/DOCX, extract text; if text or URL, proceed directly
